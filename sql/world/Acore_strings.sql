...
(30087, '|cffffff00[|cffff0000反作弊警报|r|cffffff00]:|r |cFFFF8C00|r |cFFFF8C00[|Hplayer:%s|h%s|h|r|cFFFF8C00] - Latency: %u ms', NULL, NULL, NULL, NULL, NULL, '|cffffff00[|cffff0000ANTITRAMPAS警报|r|cffffff00]:|r |cFFFF8C00|r |cFFFF8C00[|Hplayer:%s|h%s|h|r|cFFFF8C00] - Latency: %u ms', '|cffffff00[|cffff0000ANTITRAMPAS警报|r|cffffff00]:|r |cFFFF8C00|r |cFFFF8C00[|Hplayer:%s|h%s|h|r|cFFFF8C00] - Latency: %u ms', NULL),
(30088, '|cffffff00[|cffff0000反作弊警报|r|cffffff00]:|r 检测到可能的非法传送|cFFFF8C00 %s|r - Latency: %u ms', NULL, NULL, NULL, NULL, NULL, '|cffffff00[|cffff0000ANTITRAMPAS警报|r|cffffff00]:|r 检测到可能的 TELEPORT HACK|cFFFF8C00 %s|r - Latency: %u ms', '|cffffff00[|cffff0000ANTITRAMPAS警报|r|cffffff00]:|r 检测到可能的 TELEPORT HACK|cFFFF8C00 %s|r - Latency: %u ms', NULL),
(30089, '|cffffff00[|cffff0000反作弊警报|r|cffffff00]:|r POSSIBLE IGNORE CONTROL HACK DETECTED|cFFFF8C00 %s|r - Latency: %u ms', NULL, NULL, NULL, NULL, NULL, '|cffffff00[|cffff0000ANTITRAMPAS警报|r|cffffff00]:|r 检测到可能被黑客控制|cFFFF8C00 %s|r - Latency: %u ms', '|cffffff00[|cffff0000ANTITRAMPAS警报|r|cffffff00]:|r 检测到可能被黑客控制|cFFFF8C00 %s|r - Latency: %u ms', NULL),
(30090, '|cffffff00[|cffff0000反作弊警报|r|cffffff00]:|r 决斗时使用的传送技巧|cFFFF8C00 %s|r - Latency: %u ms vs |cFFFF8C00 %s|r - Latency: %u ms.', NULL, NULL, NULL, NULL, NULL, '', '', NULL);
